Rails.application.routes.draw do
  # JWKS endpoint for TEP token verification (RFC 7517)
  get "/.well-known/jwks.json", to: "api/well_known/jwks#jwks"
  get "health/check"
  namespace :api do
    namespace :v1 do
      ...
      post "storage/batch", to: "storage#batch"
       ...
       post "payments/:payment_id/mfa/verify", to: "payments#mfa_verify"
        ...
        namespace :social do
          ...
          resources :creators, only: [ :show, :update ], constraints: { id: /[@\w\.\-]+/ } do
