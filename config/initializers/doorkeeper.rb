...
Doorkeeper.configure do
  # TMCP Protocol Section 4.2: OAuth 2.0 + PKCE compliance
  orm :active_record

  # TMCP-specific scopes (Protocol Section 5.1)
  default_scopes :public
  optional_scopes :user_read, :user_read_extended, :user_read_contacts,
                  :wallet_balance, :wallet_pay, :wallet_history,
                  :messaging_send, :messaging_read,
                  :storage_read, :storage_write

  # PKCE support (required by TMCP Protocol)
  grant_flows %w[authorization_code]

  # TEP token configuration (Protocol Section 4.3)
  # Note: JWT configuration will be handled via custom token generator
  access_token_expires_in 1.hour  # TMCP requirement
  use_refresh_token

  # TMCP-specific resource owner authenticator
  resource_owner_authenticator do |routes|
    # TMCP uses Matrix-based authentication
    # This will be implemented in the authentication controller
    current_user || redirect_to("/auth/matrix_login")
  end
  ...
  # Force HTTPS in production (TMCP Protocol Section 3.3)
  force_ssl_in_redirect_uri !Rails.env.development?

  # Enforce PKCE for all authorization code flows (TMCP requirement)
  force_pkce
end
