...
gem "propshaft"
# Tailwind CSS for admin dashboard styling
...
# JWT for TEP tokens (TMCP Protocol Section 4.3)
gem "jwt"

# TOTP MFA for admin authentication
gem "rotp", "~> 6.0"
...
# Rate limiting (TMCP Protocol Section 11.4.1)
gem "rack-attack"

# CORS support
gem "rack-cors"

# Matrix integration (TMCP Protocol Section 3.1.2)
gem "matrix_sdk"

# Secure random for tokens and keys
gem "securerandom"
