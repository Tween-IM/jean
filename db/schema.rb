...
ActiveRecord::Schema[8.1].define(version: 2026_08_22_090003) do
  ...
  create_table "phone_contact_hashes", force: :cascade do |t|
    t.datetime "created_at", null: false
  ...
  create_table "user_notification_rooms", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "matrix_room_id", null: false
    t.datetime "updated_at", null: false
    t.string "user_id", null: false
    t.index ["user_id"], name: "index_user_notification_rooms_on_user_id", unique: true
  end
